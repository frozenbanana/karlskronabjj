...
const questionsData = [
    {
        ...
        answer: "Nejdå! Kom med vanliga gymkläder. Det viktigaste är att det inte finns dragkedjor eller annat som kan skada dig, andra eller mattan under sparring. Om du bestämmer dig för att fortsätta långsiktigt bör du införskaffa en GI. Det hjälper vi dig gärna med."
    },

    {
        question: 'Kan jag börja mitt i en termin som nybörjare?',
        answer: "Absolut! Det är bara att komma. När det finns flera nya på passet delar vi upp teknikdelen av träningen så att ni nya får en passade introduktion samtidigt som mer erfarna kan fokusera på sitt."
    },
